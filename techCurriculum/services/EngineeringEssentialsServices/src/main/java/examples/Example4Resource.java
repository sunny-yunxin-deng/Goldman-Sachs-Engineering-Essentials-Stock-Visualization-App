...
public class Example4Resource {
    ...
    public Response getSampleEvent() throws IOException{
        Event event = FileHelper.readSingleEvent("/Users/yunxindeng/Desktop/Sophomore/Spring2019/Engineering Essentials/EngineeringEssentials/techCurriculum/services/EngineeringEssentialsServices/data/single-event.json");
