...
public class Example5Resource {
    ...
    public Response getAllEvents() throws IOException {
        ...
        List<Event> events = FileHelper.readAllEvents("/Users/yunxindeng/Desktop/Sophomore/Spring2019/Engineering Essentials/EngineeringEssentials/techCurriculum/services/EngineeringEssentialsServices/data/events.json");
